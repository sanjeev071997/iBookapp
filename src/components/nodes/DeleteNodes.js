...
const DeleteNodes = ({nodes}) => {
    ...
    const [nodesId, setNodesId] = useState(nodes._id)
    ...
    const handleDelete = async(e) => {
        ...
        try {
            ...
            const res = await axios.delete(`${API}/api/v1/nodes/delete/${nodesId}`,
                {
                    headers: {
                ...
                <div className="modal-dialog modal-confirm">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <p>Do you really want to delete these nodes? This process cannot be undone.</p>
                        </div>
